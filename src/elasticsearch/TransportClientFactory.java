...
public class TransportClientFactory {
  ...
  public TransportClientFactory(Map<String, String> settings, String clientTransportHost, Integer clientTransportPort) {
  ...
  public TransportClient build() throws ElasticsearchUnavailableException {
    ...
    try {
      ...
      client = TransportClient.builder().settings(s).build().addTransportAddress(new InetSocketTransportAddress(inetAddress, clientTransportPort));
    } catch (Exception e) {
